...
document.addEventListener('DOMContentLoaded', () => {
    // Tangkap semua elemen di sini agar pasti sudah ada
...
// --- Fungsi-fungsi Handler (Login, Update, dll) ---
...
// --- Fungsi untuk mengambil data dari server (Fetch) ---
